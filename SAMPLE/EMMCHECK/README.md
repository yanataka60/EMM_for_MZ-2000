# EMMCHECK for MZ-2000_SD

　EMMボートの512K S-RAMの内容とMZ-2000_SDのファイルの内容を比較します。
...
　選択したEMMに対応するPIO3034_x.mzt(PIO3034_1.mzt、PIO3034_2.mzt、PIO3034_3.mzt)をDOSファイル名として比較します。
