...
#### EMMxSAVE.mztを実行するときはなるべく必要最小限のファイル(@BOOT-A MZ-2000.bin、@BOOT-B MZ-2000.bin、@BOOT-A MZ-80B.bin、@BOOT-B MZ-80B.bin、EMMxSAVE.mzt)だけが登録された専用のSDカードでの実行で行ってください。
